...
public class InfoRestControllerTestCase extends AbstractRestControllerTestCase {
    ...
    public void getShouldReturnAppInfo() throws Exception {
        when(service.getInfo()).thenReturn(new MessageResource("running v1 on 2020-05-15"));
